...
AddEventHandler('esx_phone:loaded', function(phoneNumber, contacts)
	...
	--Negative answer
	TriggerEvent('esx_phone:registerMessageCallback', 'negative_copy', function(sender, phoneNumber, type, message, position)
		TriggerServerEvent('esx_phone:send', 'player', phoneNumber, GetPlayerName(PlayerId()), '~b~Aucun dépaneur disponible')
	end)
...
RegisterNUICallback('select', function(data, cb)
		...
		if data.menu == 'vehiclespawner' then
			...
			IsOnDuty = true --Puts player on duty
